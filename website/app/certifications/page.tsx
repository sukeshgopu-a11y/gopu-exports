...
const CERTS = [
  ...
  },
  {
    ...
    desc: "Systematic preventive approach to food safety — identifies physical, chemical, and biological hazards in the production process and defines critical control measures.",
    icon: "✅",
  ...
  },
  {
    ...
    desc: "Issued by the Director General of Foreign Trade, Government of India. Mandatory for all export/import operations — identifies GOPU Exports as a legitimate exporter.",
    icon: "📑",
  ...
  },
  {
    ...
    desc: "Registered with the Spice Board of India — the statutory body for export of spices and spice products, ensuring compliance with international spice quality standards.",
    icon: "🌶️",
      ...
      <section className="relative overflow-hidden bg-[#071624]">
        ...
        <div className="relative z-10 mx-auto max-w-[1450px] px-6 py-24 sm:px-8 lg:py-32">
          ...
          <p className="mt-6 max-w-xl text-[17px] leading-[1.8] text-slate-300">
            ...
            commodities — APEDA, FSSAI, ISO 22000, HACCP, and more — ensuring every
            shipment complies with destination-country import regulations.
          </p>

          <div className="mt-10 flex flex-wrap gap-3">
            {["APEDA", "FSSAI", "ISO 22000", "HACCP", "IEC", "Spice Board"].map((cert) => (
              <span
                key={cert}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-[15px] leading-[1.9] text-[#64748B]">
                ...
                Documents are emailed immediately after vessel departure.
              </p>
              <Link
                href="/contact"
            ...
            <div className="grid grid-cols-2 gap-3">
              {DOCS.map((doc) => (
                <div
                  key={doc}
                  className="flex items-center gap-3 rounded-xl border border-[#D9E2EC] bg-white p-4 text-[14px] font-semibold text-[#374151]"
                >
                  <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-[#E6F4F7] text-[12px] font-bold text-[#0E7490]">
                    ✓
                  </span>
                  {doc}
                </div>
        ...
        <div className="mx-auto max-w-[1450px] px-6 sm:px-8">
          <div className="rounded-2xl bg-[#0E7490] p-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-[15px] leading-[1.8] text-white/80">
              Contact our team and receive the complete document package —
              phytosanitary, COA, fumigation, COO, and more — for your specific product.
            </p>
